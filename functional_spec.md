...
- [3. Functional Requirements](#3-functional-requirements)
  * [3.1 Parse Timetables from Legacy System](#31-parse-timetables-from-legacy-system)
    + [Description](#description)
    + [Criticality](#criticality)
    + [Technical Issues](#technical-issues)
    + [Dependencies with other requirements](#dependencies-with-other-requirements)
  * [3.2 Search and View Timetable](#32-search-and-view-timetable)
  ...
  * [3.3 Export Timetables](#33-export-timetables)
...
### 3.1 Parse Timetables from Legacy System
#### Description
